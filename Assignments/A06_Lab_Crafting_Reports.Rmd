---
title: "EmmaBeyer_A06_CraftingReports.Rmd"
author: "Emma Beyer"
date: "Fall 2023"
output:
  pdf_document:
...
```{r data.summary, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE}
...
```{r 2018 Ozone boxplot, echo=FALSE, fig.align='left', fig.cap="Recorded Ozone in 2018", fig.dim=c(6,4), message=FALSE, warning=FALSE}
# filtering data to be only in 2018
epa_data_2018 <- filter(epa_data, Year == 2018)
#creating boxplot for 2018
epa_boxplot_2018 <- ggplot(filter(epa_data_2018),
                          ...
                          scale_x_discrete(name="Month",
                                           drop=FALSE)
print(epa_boxplot_2018)
```

```{r 2019 Ozone boxplot, echo=FALSE, fig.align='left', fig.cap="Recorded Ozone in 2019", fig.dim=c(6,4), message=FALSE, warning=FALSE}
# filtering data to be only in 2018
epa_data_2019 <- filter(epa_data, Year == 2019)
# creating boxplot for 2019
epa_boxplot_2019 <- ggplot(filter(epa_data_2019),
                           # plotting temperature by month
                            aes(y=Ozone,
                                x=factor(Month,
                                         levels=1:12,
...
[GitRepositoryLink](https://github.com/emmabeyer/EDE_Fall2023)
