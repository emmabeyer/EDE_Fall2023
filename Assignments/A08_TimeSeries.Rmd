...
GaringerOzone <- bind_rows(garinger_2010, garinger_2011, garinger_2012, garinger_2013, garinger_2014, garinger_2015, garinger_2016, garinger_2017, garinger_2018, garinger_2019)
...
# 5 - Not sure how to use as seq function or understand which column you want me to change
Days <-
  GaringerOzone_processed %>% 
  filter(as.date.frame(seq())) %>%
  rename(new_column_name = old_column_name)
# 6 - Not sure how to use left_join
...
ggplot(GaringerOzone, aes(x = Date, y = Daily.Max.8.hour.Ozone.Concentration)) +
  ...
  labs(x = "Date", y = expression("O3 Concentrations (ppm)"))
print(ozone_plot)
```
