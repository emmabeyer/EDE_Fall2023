...
> Answer: Ozone concentrations have decreased slightly, but not much over the last ten year. The p-value shows that there was no significant change (pvalue = 0.16323). 
...
summary(GaringerOzone_monthly_nonseasonal)
