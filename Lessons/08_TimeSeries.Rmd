...
```{r}
# use to look at the arrangements, x and s.window are what we will use
?stl
...
# another way to call the time series variables
# defining first month
...
# see that this is a seasonal dataset
...
> Answer:There is a deacresing trend over time in wind speed.
