...
#View using sf plot
# Quick and ready plot
plot(GasPlants['status'],pch=16)

#View using ggplot
# points in geographic space
...
EPAair.sf <- EPAair.sites %>% 
  st_as_sf(coords = c('mean_Lng','mean_Lat'),
           crs=4326)
# lat and long columns are combined into one geospatial column
...
# doesn't known where it in map it should go
...
# now puts it into map be/c of assigned coordinate system
...
# can now click on point and see attributes in map
...
# projecting the data to 32617
# st_transform reprojects data into specified coordinate system
...
# lat/long in meters (found this on website in metadata)
